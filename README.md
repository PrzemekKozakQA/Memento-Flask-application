...
Integration tests written in Postman are run using the Newman command line tool. After performing the tests, a report is generated in an .html file. A [sample test report](https://htmlpreview.github.io/?https://github.com/PrzemekKozakQA/Memento-memory_helper_web_app/blob/add-example-test-report/Postman_tests/sample_test_report.html).  
